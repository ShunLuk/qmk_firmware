...
// Right thumb only has 2 slots here (vs. 4 on elephant42), so Backspace and
// the OSL(_NUM) key are merged: tap for Backspace, hold for the Num layer.
#define KC_BSNM LT(_NUM, KC_BSPC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //`-------+-------+-------+-------+-------+-------|                                    |-------+-------+-------+-------+-------+-------'
                              OSL(2), KC_SPC, KC_ESC,                                      KC_ENT, KC_BSNM
  //                        `-------+-------+-------'                                    `-------+-------'
  ),
  ...
  //|-------+-------+-------+-------+-------+-------|                                    |-------+-------+-------+-------+-------+-------|
     KC_NO, KC_LALT, KC_TAB, KC_S,   KC_R,   KC_G,                                         KC_LBRC, KC_QUOT, KC_DOWN, KC_UP, KC_NO, KC_NO,
  //`-------+-------+-------+-------+-------+-------|                                    |-------+-------+-------+-------+-------+-------'
                              OSL(2), KC_SPC, KC_ESC,                                      KC_ENT, KC_BSNM
  //                        `-------+-------+-------'                                    `-------+-------'
  ),
  ...
  //|-------+-------+-------+-------+-------+-------|                                    |-------+-------+-------+-------+-------+-------|
      KC_NO , KC_NO, LCTL(LSFT(KC_TAB)), KC_DOWN, LCTL(KC_W), KC_NO,                        KC_NO, KC_NO, KC_PGDN, KC_NO,  KC_NO, KC_NO,
  //`-------+-------+-------+-------+-------+-------|                                    |-------+-------+-------+-------+-------+-------'
                              KC_TRNS, KC_SPC, KC_ESC,                                      KC_ENT, KC_TRNS
  //                        `-------+-------+-------'                                    `-------+-------'
  ),
  ...
  //|-------+-------+-------+-------+-------+-------|                                    |-------+-------+-------+-------+-------+-------|
      KC_NO, KC_0,   KC_1,   KC_2,   KC_3,  KC_BSLS,                                     KC_LBRC, KC_AT, KC_AMPR, KC_DLR, KC_RBRC, KC_NO,
  //`-------+-------+-------+-------+-------+-------|                                    |-------+-------+-------+-------+-------+-------'
                              KC_TRNS, KC_SPC, KC_ESC,                                      KC_ENT, OSL(4)
  //                        `-------+-------+-------'                                    `-------+-------'
  ),
