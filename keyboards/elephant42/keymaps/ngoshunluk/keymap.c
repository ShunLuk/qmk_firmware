...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
  //,-------+-------+-------+-------+-------+-------.                                    ,-------+-------+-------+-------+-------+-------.
     KC_NO,   KC_Q  , KC_W  , KC_E  , KC_R  , KC_T  ,                                      KC_Y  , KC_U  , KC_I  , KC_O  , KC_P  , DF(0),
  //|-------+-------+-------+-------+-------+-------|                                    |-------+-------+-------+-------+-------+-------|
  ...
  //        `-------+-------+-------+-------+-------+-------+-------.    ,-------+-------+-------+-------+-------+-------+-------'
                                     KC_NO, LT(2,KC_ESC), KC_SPC, KC_NO,  KC_NO, OSL(3), KC_BSPC, KC_NO
  //                                `-------+-------+-------+-------'    `-------+-------+-------+-------'
  ),
  ...
  //        `-------+-------+-------+-------+-------+-------+-------.    ,-------+-------+-------+-------+-------+-------+-------'
                                     KC_NO, LT(2,KC_BSPC), KC_SPC, KC_NO, KC_NO,  KC_ENT, OSL(3), KC_NO
  //                                `-------+-------+-------+-------'    `-------+-------+-------+-------'
  ),

  [_NAV] = LAYOUT(
  //,-------+-------+-------+-------+-------+-------.                                    ,-------+-------+-------+-------+-------+-------.
      KC_NO , LGUI(KC_TAB), LCTL(KC_TAB), KC_NO, LCTL(KC_T), KC_NO,                        KC_NO, KC_LSFT,KC_LCTL,KC_LALT,KC_LGUI,KC_NO ,
  //|-------+-------+-------+-------+-------+-------|                                    |-------+-------+-------+-------+-------+-------|
  ...
  //        `-------+-------+-------+-------+-------+-------+-------.    ,-------+-------+-------+-------+-------+-------+-------'
                                      KC_NO, KC_TRNS, KC_SPC, KC_NO,       KC_NO, KC_ENT, KC_BSPC, KC_NO
  //                                `-------+-------+-------+-------'    `-------+-------+-------+-------'
  ),

  [_NUM] = LAYOUT(
  //,-------+-------+-------+-------+-------+-------.                                    ,-------+-------+-------+-------+-------+-------.
      KC_NO, KC_TILD, KC_7,   KC_8,   KC_9,  KC_MINS,                                     KC_LPRN,KC_QUOT,KC_DQUO,KC_PSLS,KC_RPRN, KC_NO,
  //|-------+-------+-------+-------+-------+-------|                                    |-------+-------+-------+-------+-------+-------|
  ...
  //        `-------+-------+-------+-------+-------+-------+-------.    ,-------+-------+-------+-------+-------+-------+-------'
                                      KC_NO,  KC_ESC, KC_SPC, KC_NO,        KC_NO, KC_ENT, OSL(4), KC_NO
  //                                `-------+-------+-------+-------'    `-------+-------+-------+-------'
  ),
  ...
  //        `-------+-------+-------+-------+-------+-------+-------.    ,-------+-------+-------+-------+-------+-------+-------'
                                      KC_NO, KC_ESC,  KC_SPC, KC_NO,      KC_NO, KC_ENT, KC_BSPC, KC_NO
  //                                `-------+-------+-------+-------'    `-------+-------+-------+-------'
  )
};
